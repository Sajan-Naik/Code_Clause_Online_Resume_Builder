...
public class ExperienceUI extends JFrame implements ActionListener {
	public String Name, DOB, FatherName, Nationality, email, PhoneNo, School, College, University, SchoolFrom, SchoolTo,
			CollegeFrom, CollegeTo, UniversityFrom, UniversityTo, imagePath, English, Marathi, Hindi, Kannada;
	...
	public ExperienceUI(String Name, String DOB, String FatherName, String Nationality, String PhoneNo, String email,
			String School, String College, String University, String SchoolFrom, String SchoolTo, String CollegeFrom,
			String CollegeTo, String UniversityFrom, String UniversityTo, String imagePath, String English,
			String Marathi, String Hindi, String Kannada) {
		this.Name = Name;
		this.DOB = DOB;
		...
		b1.setBackground(Color.blue); // sets background color
	...
	public void actionPerformed(ActionEvent e) {
		...
		new Resume(Name, DOB, FatherName, Nationality, email, PhoneNo, School, College, University, SchoolFrom,
				SchoolTo, CollegeFrom, CollegeTo, UniversityFrom, UniversityTo, t1.getText(), t2.getText(),
				t3.getText(), j1.getSelectedItem().toString(), imagePath, English, Marathi, Hindi, Kannada);

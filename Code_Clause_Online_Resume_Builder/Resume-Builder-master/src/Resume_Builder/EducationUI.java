...
public class EducationUI extends JFrame implements ActionListener {
	...
	public EducationUI(String Name, String DOB, String FatherName, String Nationality, String PhoneNo, String email,
			String imagePath) {
		this.Name = Name;
		this.DOB = DOB;
		...
		l6 = new JLabel("Marathi");
		l7 = new JLabel("Hindi");
		l8 = new JLabel("Kannada");
	...
	public void actionPerformed(ActionEvent e) {
		new ExperienceUI(Name, DOB, FatherName, Nationality, email, PhoneNo, t1.getText(), t2.getText(), t3.getText(),
				j1.getSelectedItem().toString(), j2.getSelectedItem().toString(), j3.getSelectedItem().toString(),
				j4.getSelectedItem().toString(), j5.getSelectedItem().toString(), j6.getSelectedItem().toString(),
				imagePath, j7.getSelectedItem().toString(), j8.getSelectedItem().toString(),
				j9.getSelectedItem().toString(), j10.getSelectedItem().toString());
		this.dispose();
	}
